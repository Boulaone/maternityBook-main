...
INSERT INTO PARENT (
    ID_PARENT, LIEN_PARENTE, POIDS_NAIS, TAILLE_NAIS, GROUPE_SANG, DATE_NAIS, DEPARTEMENT_NAIS, ID_GROSSESSE)
VALUES(
    1,
    'Maman',
    3.68,
...
INSERT INTO `user` (
    EMAIL, PASSWORD, NOM, PRENOM, NEWSLETTER, DEM_COMMERCIAL, ROLE, ID_GROSSESSE, ID_PARENT)
VALUES(
...
INSERT INTO `user` (
    EMAIL, PASSWORD, NOM, PRENOM, NEWSLETTER, DEM_COMMERCIAL, ROLE, ID_GROSSESSE)
VALUES(
